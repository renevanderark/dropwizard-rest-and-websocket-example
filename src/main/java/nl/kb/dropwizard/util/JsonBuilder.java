...
/**
 * Attribution: Jauco Noordzij (Huygens ING 2016):
 * https://github.com/HuygensING/timbuctoo/blob/master/timbuctoo-instancev4/src/main/java/nl/knaw/huygens/timbuctoo/util/JsonBuilder.java
 * from project:
